...
from carlease.models import User, Car, User_Verified, Appointment, PasswordResetToken, EmailVerificationToken, PasswordResetToken
...
def deleteAcc():
    ...
    if request.method == 'POST':
        ...
        password_reset = PasswordResetToken.query.filter_by(user_id=current_user.id).first()
